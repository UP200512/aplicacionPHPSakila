        ...
        <div style="max-height:75%;" class="overflow-scroll">
          <table class="table table-striped table-bordered align-middle" id="registros">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  <th scope="row"><input class="form-check-input" value="<?php echo $results->language_id; ?>" type="checkbox" name="check_cell"></th>
...
<script src="index_language.js?v=<?php echo (rand()); ?>"></script>
